def run_streamlit():
   ...
   with st.sidebar:
      ...
      st.markdown(":blue[To play game online:]")
      st.markdown("* None")
      st.markdown("**:blue[SQL Script Execution Permissions:]**")
      st.markdown(":blue[1. Trial account edition:]")
      st.markdown("* Enterprise Edition trial account")
      st.markdown(":blue[2.  Or existing account Database Permissions:]")
